...
#define A1_AFFINE_INDEX_SHIFT   9
...
//Affine attribute setting
extern void SetAttrib1AffineIndex(SpriteObject* a_object, u8 a_index);
...
extern void obj_aff_identity(SpriteAffine* a_obj);
extern void obj_aff_rotscale(SpriteAffine* oaff, fixed sx, fixed sy, u16 alpha);
